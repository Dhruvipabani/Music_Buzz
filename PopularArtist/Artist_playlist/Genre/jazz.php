...
<body>
<a href="../../../genre.php" class="top-left-btn">Back</a>
    <!-- Page Preloder -->
    <div id="preloder">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="track__content nice-scroll">
                        <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_1"
                                data-url="music-files/Fly me to the moon.mp3"></div>
                        ...
                        <div class="single_player_container">
                            <h4>Your Love Is King</h4>
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_2"
                                data-url="music-files/Your Love Is King.mp3"></div>
                        ...
                        <div class="single_player_container">
                            <h4>Let's Fall in Love for the Night</h4>
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_4"
                                data-url="music-files/Let's Fall in Love for the Night.mp3"></div>
                        ...
                        <div class="single_player_container">
                            ...
                            <div class="jp-jplayer jplayer" data-ancestor=".jp_container_6"
                                data-url="music-files/She.mp3"></div>
                ...
                <div class="col-lg-5 p-0">
                    ...
                    <img src="img/4.jpeg" alt="" height="300px" width="30px">
