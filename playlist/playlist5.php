    ...
    <div class="container">
        ...
        <div class="song-list">
            ...
            Nacho Nacho
                ...
                <audio id="audio2" src="audio/Nacho Nacho.mp3"></audio>
            </div>
            <div class="song">
            Galti Se Mistake
                <button onclick="togglePlayPause(event, 'audio3')">Play</button>
                <audio id="audio3" src="audio/Galti Se Mistake.mp3"></audio>
            </div>
            <div class="song">
            Chikni Chameli
                <button onclick="togglePlayPause(event, 'audio4')">Play</button>
                <audio id="audio4" src="audio/Chikni Chameli.mp3"></audio>
            </div>
            <div class="song">
            Pungi
                <button onclick="togglePlayPause(event, 'audio5')">Play</button>
                <audio id="audio5" src="audio/Pungi.mp3"></audio>
            </div>
            <div class="song">
            Desi Girl
