    ...
    <div class="container">
        ...
        <div class="song-list">
            <div class="song">
                ...
                <audio id="audio1" src="audio/Tum Kya Mile.mp3"></audio>
            </div>
            <div class="song">
                Kesariya
                <button onclick="togglePlayPause(event, 'audio2')">Play</button>
                <audio id="audio2" src="audio/Kesariya.mp3"></audio>
            </div>
            <div class="song">
                Chaleya
                <button onclick="togglePlayPause(event, 'audio3')">Play</button>
                <audio id="audio3" src="audio/Chaleya .mp3"></audio>
            </div>
            <div class="song">
                Apna Bana Le
                <button onclick="togglePlayPause(event, 'audio4')">Play</button>
                <audio id="audio4" src="audio/Apna Bana Le.mp3"></audio>
            </div>
            <div class="song">
                Pehle bhi main
                <button onclick="togglePlayPause(event, 'audio5')">Play</button>
                <audio id="audio5" src="audio/PEHLE BHI MAIN.mp3"></audio>
            </div>
            <div class="song">
                Mere Naam Tu
