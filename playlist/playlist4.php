    ...
    <div class="container">
        ...
        <div class="song-list">
            <div class="song">
                ...
                <audio id="audio1" src="audio/Genda Phool.mp3"></audio>
            </div>
            <div class="song">
                Blue Eyes
                <button onclick="togglePlayPause(event, 'audio2')">Play</button>
                <audio id="audio2" src="audio/Blue Eyes.mp3"></audio>
            </div>
            <div class="song">
                Dhaakad
                <button onclick="togglePlayPause(event, 'audio3')">Play</button>
                <audio id="audio3" src="audio/Dhaakad.mp3"></audio>
            </div>
            <div class="song">
                Mirchi
                <button onclick="togglePlayPause(event, 'audio4')">Play</button>
                <audio id="audio4" src="audio/Mirchi.mp3"></audio>
            </div>
            <div class="song">
                Desi Kalakaar
                <button onclick="togglePlayPause(event, 'audio5')">Play</button>
                <audio id="audio5" src="audio/Desi Kalakaar.mp3"></audio>
            </div>
            <div class="song">
                Legacy
