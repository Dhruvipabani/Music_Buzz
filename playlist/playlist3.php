    ...
    <div class="container">
        ...
        <div class="song-list">
            ...
            O SAJNI RE
                ...
                <audio id="audio1" src="audio/O SAJNI RE.mp3"></audio>
            </div>
            <div class="song">
            Soulmate
                <button onclick="togglePlayPause(event, 'audio2')">Play</button>
                <audio id="audio2" src="audio/Soulmate.mp3"></audio>
            </div>
            <div class="song">
                O Maahi
                <button onclick="togglePlayPause(event, 'audio3')">Play</button>
                <audio id="audio3" src="audio/O Maahi.mp3"></audio>
            </div>
            <div class="song">
            SATRANGA
                <button onclick="togglePlayPause(event, 'audio4')">Play</button>
                <audio id="audio4" src="audio/SATRANGA.mp3"></audio>
            </div>
            <div class="song">
            Pal Pal Dil Ke Paas
                <button onclick="togglePlayPause(event, 'audio5')">Play</button>
                <audio id="audio5" src="audio/Tere Hawaale.mp3"></audio>
            </div>
            <div class="song">
            Shayad
                <button onclick="togglePlayPause(event, 'audio1')">Play</button>
